...
wnv <- read_csv(here('data/traps/wnvMIRPIR1500LagWeeks0_NA.csv')) %>% 
  ...
  dplyr::select(zipcode, clust:woy, date, pool_size, num_pools,mir_all, mir_spline_all)
...
write_csv(abund, here("data/traps/all_plotting.csv"))
```
...
traps <- vect(here('data/wnv_cases/shp_files/WNV_full_4_23_CA.shp'))
...
# st_write(traps_kern_sf, here('data/wnv_cases/shp_files/wnv_kern.shp'))
## Save csv
