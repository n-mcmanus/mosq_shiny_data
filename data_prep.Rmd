...
## put in leaflet-friendly crs and export
rasts_sum_reproj <- terra::project(rasts_sum, "+proj=longlat +datum=WGS84")
writeRaster(rasts_sum_reproj, here("data/water/summed_water_2022_2023.tif"),
            overwrite = TRUE)
```
